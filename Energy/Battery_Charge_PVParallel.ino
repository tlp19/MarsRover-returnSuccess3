...
unsigned int rest_timer, V_Counter, Discharge_Counter, Relay_Counter, SoC_ChargeCounter, Rest_Counter, Cell1_Counter, Cell2_Counter,power_counter;
...
float current_limit, current_measure, previous_current, current_ref = 0, error_amps; // Current Control
float pwm_out;
float V_Bat,Vref,vb,vref,vpd,va,previous_voltage,Voltage_Cell1,Voltage_Cell2;
float SoC = 100; //State of Charge
float open_loop,dutyref,OC;

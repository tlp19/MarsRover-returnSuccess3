...
float Capacitance_Max = 569.861, Capacitance_Consumed; //Battery 1 has capacitance_max = 569.861, battery 2 = 586.5
...
void loop() {
  ...
  if (int_count == 1000) { // SLOW LOOP (1Hz)
    ...
    dataString = String(SoC)+","+String(state_num) + "," + String(V_Bat) + "," + String(current_ref) + "," + String(current_measure)+"," + String(previous_current) + "," + String(Current_Counter) +","+ String(Area) + "," + String(Capacitance_Consumed); //build a datastring for the CSV file
